...
**Install TracIK**:
```bash
sudo apt install ros-kilted-trac-ik-lib -y
sudo apt install ros-kilted-trac-ik-python -y
```
...
**Troubleshooting**:
- **TracIK not found**: Install: `sudo apt install ros-kilted-trac-ik-python`
