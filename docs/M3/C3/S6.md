...
- Familiarity with NVIDIA Jetson hardware ecosystem (Nano, Xavier, Thor)
...
| **DLA (Deep Learning Accelerator)** | Hardware accelerator on Jetson Xavier/Thor for offloading inference from GPU, reducing power consumption |
